...
<head>
    ...
    <noscript><style>.reveal,.reveal-fade,.reveal-left,.reveal-right,.timeline-item{opacity:1!important;transform:none!important;}body{opacity:1!important;}</style></noscript>
</head>
<body>
