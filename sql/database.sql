...
('video_file','','about_video','Video (MP4 upload, portrait recommended)','video',2),
('video_thumbnail','','about_video','Poster Image (shown before play / while loading)','image',3),
('video_url','','about_video','Video URL (fallback if no video is uploaded above — YouTube link or embed URL)','link',4),
('video_heading','Social & environmental responsibility','about_video','Heading','text',5),
('video_p1','At Ruwanpura Gems, we distinguish ourselves from average retailers by maintaining a rigorous and complete chain of custody for every gemstone in our collection. Since our strategic decision in 2012 to invest directly in mining operations across Madagascar and Mozambique, we have secured the ability to oversee the journey of a gemstone from the moment it leaves the earth until it reaches your hands. This "mine-to-market" approach allows us to guarantee that every stone is sourced with the highest level of integrity and transparency.','about_video','Paragraph 1','textarea',6),
('video_p2','Our dedication to excellence extends beyond the quality of the gems to the wellbeing of the people and environmental standards. Our carefully selected mining teams operate under strict labor and environmental requirements, ensuring a safe and fair workplace for all involved. By upholding these socially and environmentally responsible practices, we ensure that every stone supplied to our wholesale buyers, jewelry manufacturers, and collectors is ethically produced and of the highest artisanal standard.','about_video','Paragraph 2','textarea',7),
('video_card1_title','Scientific integrity','about_video','Card 1 Title','text',8),
('video_card1_desc','Every gem undergoes a rigorous vetting process in our labs to meet the high standards expected by our global clientele. We ensure our stones meet all certification requirements necessary for international trade.','about_video','Card 1 Description','textarea',9),
('video_card2_title','Global distribution','about_video','Card 2 Title','text',10),
('video_card2_desc','From our roots in Sri Lanka to our operations in Bangkok, Hong Kong, and Chicago, we have established a seamless network providing peace of mind and top-quality products to the world.','about_video','Card 2 Description','textarea',11),
