                ...
                <td class="row-actions">
                    <details style="display:inline-block;">
                        ...
                        <form method="post" style="margin-top:10px;min-width:220px;">
                            ...
                            <input type="hidden" name="id" value="<?= (int) $a['id'] ?>">
                            <div class="password-field" style="margin-bottom:8px;">
                                <input type="password" name="new_password" class="form-control" placeholder="New password" minlength="6" required autocomplete="new-password">
